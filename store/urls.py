...
#     path('product/add/', views.add_product, name='add_product'),
#     path('product/<int:product_id>/delete/', views.delete_product, name='delete_product'),
#     path('product/<int:product_id>/details/', views.see_details, name='details'),



#     path('save_product/<int:product_id>/', views.save_product, name='save_product'),
#     path('cart/', views.saved_products, name='cart'),
#     path('cart/delete/<int:item_id>/', views.delete_saved_product, name='delete_saved_product'),
#     path('cart/buy/<int:item_id>/', views.buy_item, name='buy_item'),


#     path('orders/', views.see_orders, name='orders'),
#     path('orders/user/<int:user_id>/', views.user_orders, name='user_orders'),
#     path('orders/admin/', views.admin_orders, name='admin_orders'),
#     path('orders/pay/<int:order_id>/', views.pay_order, name='pay_order'),
